...
Formulate problem statements using the UX template: "[User] needs a way to [achieve goal] because [obstacle], which results in [impact]." Develop two clear problem statements for each scenario that highlight specific user difficulties.

STEP 4: Select Research Methods
Identify suitable research methods to explore user needs and validate design solutions. For example:
...
Based on realistic assumptions or existing data, create at least two user personas per scenario. Include: Demographics (age, occupation, location) Goals and motivations Behaviors and habits Pain points and frustrations Quotes or statements representing user perspective

STEP 7: Summarize Findings
Summarize how the identified pain points, problem statements, research methods, and personas connect to guide user-centered design decisions for both projects. Highlight how the proposed solutions aim to improve usability, accessibility, and user satisfaction.
...
<img width="1857" height="868" alt="image" src="https://github.com/user-attachments/assets/ae01b512-ac81-4f30-8fa5-a294ab6ae4d2" />


# Scenario 2: Designing a Smart Waste Management App for Urban

<img width="1686" height="880" alt="image" src="https://github.com/user-attachments/assets/f3a7fed9-a3da-4448-8539-41f64289dec2" />
